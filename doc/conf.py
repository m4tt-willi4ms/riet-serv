# -*- coding: utf-8 -*-
#
# PROTO Rietveld Refinement documentation build configuration file, created by
...
project = u'PROTO Rietveld Refinement'
copyright = u'2017, M. Williams'
author = u'M. Williams'
...
htmlhelp_basename = 'PROTORietveldRefinementdoc'
...
man_pages = [
    (master_doc, 'protorietveldrefinement', u'PROTO Rietveld Refinement Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PROTORietveldRefinement', u'PROTO Rietveld Refinement Documentation',
     author, 'PROTORietveldRefinement', 'One line description of project.',
     'Miscellaneous'),
]
