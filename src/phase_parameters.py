...
DEFAULT_PEAK_PARAMETERS = [
    ...
    ('pp_P', 0.00, [False], -0.1, 0.1),
    ('pp_X', 1.0, [False], 0.001, 10),
...
class PhaseParameters(rp.RefinementParameters):
    ...
    def __init__(
            ...
            pref_or=DEFAULT_PREF_OR_PARAMS,
            peak_parameters=DEFAULT_PEAK_PARAMETERS,
            param_dict=None):
    ...
    def param_gen(self):
        ...
        # d['eta'] = self.eta
        d['peak_parameters'] = self.peak_parameters
        if self.phase_settings['recompute_peak_positions']:
